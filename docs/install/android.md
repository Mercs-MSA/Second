...
![open.png](../media/android_install/open.png)

![allow_unknown_sources.png](../media/android_install/allow_unknown_sources.png)
...
![installed.png](../media/android_install/installed.png)
